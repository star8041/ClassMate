...
public class TeacherChatService {
    ...
    @Transactional
    public Flux<String> sendMessage(Long teacherId, Long sessionId, String messageText) {
        ChatSession session = chatSessionService.getOwnedSession(sessionId, teacherId);
        ...
        return agentExecutor.executeStream(context)
                ...
                .doOnError(e -> log.error("[TeacherChat] 스트리밍 오류 sessionId={}", sessionId, e));
    }
